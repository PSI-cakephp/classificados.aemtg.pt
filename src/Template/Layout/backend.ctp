...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>Classificados</span>
    </a>
                ...
                <ul class="menu">
                    ...
                    <a href="#">
                      <div class="pull-left">
                        <!--<img src="dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">!-->
                         <?=$this->Html->image('backend/user3-128x128.jpg', ['class' => 'img-circle'])?>
                      </div>
                      <h4>
                    ...
                    <a href="#">
                      <div class="pull-left">
                        <!--  <img src="dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">-->
                                 <?=$this->Html->image('backend/user4-128x128.jpg')?>
                      </div>
                      <h4>
                        Developers
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                         <!--<img src="dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">!-->
                         <?=$this->Html->image('backend/user3-128x128.jpg')?>
                      </div>
                      <h4>
                        Sales Department
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 5 Novos utilizadores se registaram
                    </a>
                  </li>
                  <li>
                    <a href="#">
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i>25 Novos Anúncios
                    </a>
                  </li>
                  <li>
                    <a href="#">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <!--<img src="dist/img/user2-160x160.jpg" class="user-image" alt="User Image">-->
                 <?=$this->Html->image('backend/user2-160x160.jpg',['class' => 'user-image'])?>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i>Número de Anúncios p/ano</li>
            </ul>
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <div class="item">
                <!--<img src="dist/img/user2-160x160.jpg" alt="user image" class="offline">-->
                    <?=$this->Html->image('backend/user2-160x160.jpg')?>
                <p class="message">
                  <a href="#" class="name">
...
<?=$this->Html->script('backend/plugins/morris/morris.min.js')?>


<!-- Sparkline -->
<?=$this->Html->script('backend/plugins/sparkline/jquery.sparkline.min.js')?>

<!-- jvectormap -->

<?=$this->Html->script('backend/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')?>

<?=$this->Html->script('backend/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')?>

<!-- jQuery Knob Chart -->
<?=$this->Html->script('backend/plugins/knob/jquery.knob.js')?>

<!-- daterangepicker -->
<?=$this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js')?>

<?=$this->Html->script('backend/plugins/daterangepicker/daterangepicker.js')?>

<!-- datepicker -->

<?=$this->Html->script('backend/plugins/datepicker/bootstrap-datepicker.js')?>
<!-- Bootstrap WYSIHTML5 -->
<?=$this->Html->script('backend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')?>
...
<?=$this->Html->script('backend/pages/dashboard.js')?>
